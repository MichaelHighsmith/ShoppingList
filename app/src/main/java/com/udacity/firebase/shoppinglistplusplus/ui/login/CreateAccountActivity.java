...
import static com.udacity.firebase.shoppinglistplusplus.utils.Constants.*;
...
public class CreateAccountActivity extends BaseActivity {
    ...
    public void onCreateAccountPressed(View view) {
        ...
        //Check that the email and username are okay
        ...
        //Create new user with the entered email and password
        mFirebaseRef.createUser(mUserEmail, mPassword, new Firebase.ValueResultHandler<Map<String, Object>>(){
            ...
            public void onError(FirebaseError firebaseError){
                //Error occurred, log it and dismiss the progress dialog
